    ...
    class Program
    {
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                int nonZeroIndex = 0; // Initialize the index to track non-zero elements
                ...
                for (int i = 0; i < nums.Length; i++)
                {
                    ...
                    {
                        nums[nonZeroIndex] = nums[i]; // Move it to the nonZeroIndex position
                ...
                return new List<int>(nums);  // Return the modified array
            }
            catch (Exception)
            {
                throw;
        ...
        */
        ...
        public static IList<IList<int>> ThreeSum(int[] nums)
        {
            try
            {
                ...
                List<IList<int>> result = new List<IList<int>>(); // Initialize a list to store the triplets

                if (nums == null || nums.Length < 3)
                {
                    return result; // Return empty list for input with less than three elements
                }
                ...
                for (int i = 0; i < nums.Length - 2; i++) // Iterate through the array
                {
                    ...
                    int left = i + 1; // Initialize left pointer pointing to the next element after nums[i]
                    int right = nums.Length - 1; // Initialize right pointer pointing to the last element of the array
                    ...
                    while (left < right) // Loop until left pointer is less than right pointer
                    {
                        ...
                        if (sum == 0) // If the sum is zero, we found a triplet
                        {
                            ...
                            right--; // Move right pointer to the previous element
                        }
                        else if (sum < 0) // If sum is less than zero, increment left pointer
                        {
                            left++;
                        }
                        else // If sum is greater than zero, decrement right pointer
                        {
                            right--;
                        }
                    }
        ...
        */
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            try
            {
                if (nums.Length == 0) // Check if the input array is empty
                return 0;

                int maxCount = 0; // Initialize the maximum consecutive count
                int currentCount = 0; // Initialize the current consecutive count

                foreach (int num in nums)
                {
                    if (num == 1) // If the current element is 1
                    {
                        currentCount++; // Increment the consecutive count
                        maxCount = Math.Max(maxCount, currentCount); // Update the maximum consecutive count
                    }
                    else // If the current element is 0
                    {
                        currentCount = 0; // Reset the consecutive count
                    }
                }
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            try
            {
                ...
                int baseValue = 1; // Initialize the base value to 2^0 = 1
                ...
                while (binary > 0)
                {
                    ...
                    decimalNumber += lastDigit * baseValue; // Update the decimal number using the last digit
                    baseValue *= 2; // Update the base value for the next digit (2^1, 2^2, ...)
                }

                return decimalNumber; // Return the calculated decimal number
            }
            catch (Exception)
            {
                throw;
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                ...
                int maxDiff = 0; // Initialize the maximum difference between successive elements
        ...
        */
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                {
                    if (nums[i - 1] + nums[i - 2] > nums[i]) // Check if triangle inequality holds
                    {
                        return nums[i - 1] + nums[i - 2] + nums[i]; // Return the largest perimeter
                    }
                }

                return 0; // If no triangle with non-zero area can be formed, return 0
            }
            catch (Exception)
            {
                throw;
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            try
            {
                ...
                {
                    return s; // Return s unchanged if either s or part is empty or null
                }

                // Find the leftmost occurrence of part in s
                int index = s.IndexOf(part);

                // Handle case where part is not found in s
                while (index != -1)
                {
                    // Remove part from s starting at index
                    s = s.Remove(index, part.Length);

                    // Find the next occurrence of part in the modified s
                    index = s.IndexOf(part);
                }

                return s; // Return the modified string after all occurrences of part are removed
            }
            catch (Exception)
            {
                throw;
